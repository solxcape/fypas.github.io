<?php 
$user = $conn->query("SELECT s.*,d.name as department, c.name as curriculum,CONCAT(lastname,', ',firstname,' ',matrix) as fullname FROM student_list s inner join department_list d on s.department_id = d.id inner join curriculum_list c on s.curriculum_id = c.id where s.id ='{$_settings->userdata('id')}'");
            ...
            <div class="container-fluid">
                <form action="" id="update-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="matrix" class="control-label text-navy">Matrix No</label>
                                <input type="text" name="matrix" id="matrix" placeholder="Matrix No" class="form-control form-control-border" value="<?= isset($matrix) ?$matrix : "" ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
