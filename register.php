...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h1 class="text-center py-5 login-title"><b>FYP Archive System- Student</b></h1>
      </div>
                ...
                <div class="card-body">
                    <form action="" id="registration-form">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" name="matrix" id="matrix" placeholder="Matrix No" class="form-control form-control-border" required>
                                </div>
                            </div>
                        </div>
                        </div>
