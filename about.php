            ...
            <div class="card card-outline card-navy rounded-0 shadow">
                ...
                <div class="card-body rounded-0">
                    <dl>
                        ...
                        <dd class="pr-4">ukk@psp.edu.my</dd>
                        <dt class="text-muted"><i class="fa fa-phone"></i> Contact </dt>
                        <dd class="pr-4">04-5389266</dd>
                        <dt class="text-muted"><i class="fa fa-map-marked-alt"></i> Location</dt>
                        <dd class="pr-4">Politeknik Seberang Perai , Jalan Permatang Pauh
13500 Permatang Pauh, Pulau Pinang.</dd>
                    </dl>
                </div>
            </div>
        </div>
